...
# Note tht it is not enough just to import openpyxl (lthough I migth could do from openpyxl import *
from openpyxl import Workbook
from openpyxl.styles import *
from openpyxl.worksheet.table import Table, TableStyleInfo

#Opening the text file for reading
text_file = open("C:\\Users\\Dad\\Documents\\Python_Course\\employees.txt")
...
# not that python understands that the element in the for loop is the first line red from the file, since we are using readlines
...
file_path = "C:\\Users\\Dad\\Documents\\Python_Course\\exe\\MyCompanyStaff.xlsx"
...
# Once the append taes place, you now have official ros and columns. They are not written
#to the Excel spreadshett file yet, but they eist in memory
for row in records:
    sheet.append(row)
